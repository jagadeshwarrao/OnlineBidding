    ...
    if request.method == 'POST':
        ...
        if p1 == p2:
            if User.objects.filter(email=mail).exists():
                ...
                to      = mail  
                res     = send_mail(subject, msg, "gowthamjagadeeswararao@gmail.com", [to])
                if res == 1:
...
def homepage(request):
    introduction = "Welcome to the Auction Management System. This system provides a platform for conducting online auctions, allowing users to bid on various items and manage their auction activities. With our user-friendly interface and advanced features, you can easily create auctions, track bids, and manage the entire auction process. Whether you're a seller looking to showcase your items or a bidder eager to participate in exciting auctions, our Auction Management System has got you covered. Start exploring and enjoy the thrill of online bidding!"

    return render(request, "homepage.html", {"introduction": introduction})
...
def base7(request):
    return render(request, "base7.html")